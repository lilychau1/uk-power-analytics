...
from common.file_config import batch_bmrs_generation_output_filepath, batch_bmrs_generation_json_raw_output_filepath
...
df = spark.read.json(batch_bmrs_generation_json_raw_output_filepath, schema=schema)
...
logger.info(f'Saving BMRS {BmrsDataCategory.GENERATION.name} data to local folder {batch_bmrs_generation_output_filepath}...')

# Save dataframe as parquet
df.write.mode('overwrite').parquet(batch_bmrs_generation_output_filepath)
