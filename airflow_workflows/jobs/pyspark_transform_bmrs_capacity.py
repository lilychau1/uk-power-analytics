...
from common.file_config import initialise_bmrs_capacity_output_filepath, initialise_bmrs_capacity_json_raw_output_filepath
...
df = spark.read.json(initialise_bmrs_capacity_json_raw_output_filepath, schema=schema)
...
logger.info(f'Saving BMRS {BmrsDataCategory.CAPACITY.name} data to local folder {initialise_bmrs_capacity_output_filepath}...')

# Save dataframe as parquet
df.write.mode('overwrite').parquet(initialise_bmrs_capacity_output_filepath)
